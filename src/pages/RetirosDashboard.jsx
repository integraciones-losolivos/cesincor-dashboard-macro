...
export default function RetirosDashboard({ areaName = 'Retiros' }) {
  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#ffe4e6_0,#f8fafc_36%,#f8fafc_100%)]">
