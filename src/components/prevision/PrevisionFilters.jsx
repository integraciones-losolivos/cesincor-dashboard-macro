...
export default function PrevisionFilters({
  ...
  return (
    <section className="card-shadow overflow-hidden rounded-2xl border border-slate-200/80 bg-white">
      <div className="grid gap-4 border-b border-orange-200 bg-gradient-to-r from-orange-900 to-orange-700 p-4 text-white lg:grid-cols-[1fr_auto] lg:items-center">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-5 text-orange-100">Panel compacto alineado a Crystal: Tipo de afiliación, localidad, convenio, plan, asesora y estado.</p>
          </div>
        </div>
      ...
      <div className="border-b border-slate-100 px-4 py-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-orange-600 bg-orange-50 px-4 py-2 text-sm font-black text-orange-800 transition hover:bg-orange-100 disabled:cursor-wait disabled:opacity-60"
          >
    ...
    <button
      ...
      className={`min-h-11 rounded-xl border px-4 py-2 text-sm font-black transition ${
        active
          ...
          : 'border-slate-300 bg-white text-slate-700 hover:border-orange-600 hover:bg-orange-50'
      }`}
    >
      {children}
    </button>
